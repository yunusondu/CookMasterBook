package com.yondusoftware.yemektariflerisqlite
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")) {
                ...
                val gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources,R.drawable.gorselsecim)
                ...
                context?.let {
                    try {
                        val db = it.openOrCreateDatabase("Yemekle   r",Context.MODE_PRIVATE,null)
                        ...
                        while (cursor.moveToNext()) {
                            yemekIsmiText.setText(cursor.getString(yemekMalzemeIndex))
    ...
    fun kucukBitmapOlustur(kullanicininSextigiBitmap: Bitmap, maximumBoyut: Int) : Bitmap {

        var width = kullanicininSextigiBitmap.width
        var height = kullanicininSextigiBitmap.height
        ...
        return Bitmap.createScaledBitmap(kullanicininSextigiBitmap, width / 2, height / 2 ,true)
